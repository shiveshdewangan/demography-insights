...
def get_status_color(rem):
        ...
        if percent > 70: return "#379634"   # Healthy Green
        if percent > 40: return "#fee440"   # Warning Orange
        if percent > 15: return "#e03616"   # Danger Red
...
with st.sidebar:
    ...
    if pct_used < 50: status_color = "#379634" # Green
    elif pct_used < 80: status_color = "#fee440" # Orange
    else: status_color = "#e03616" # Red
        ...
        st.markdown("""
            <div style="background-color: #ffffff; 
                ...
                <p style="margin: 0; font-size: 12px; color: #4b5563; line-height: 1.5;">
                    Unlock <b>unlimited queries</b>, CSV data insights, and priority suburb analysis.
                </p>
        ...
        """, unsafe_allow_html=True)
         ...
         st.markdown("""
            <div style="background-color: #ffffff; 
                ...
                <div style="margin: 8px 0; height: 1px; background-color: #f3f4f6;"></div>
                <p style="margin: 0; font-size: 12px; color: #4b5563; line-height: 1.5;">
                    Unlocked <b>unlimited queries</b>, data insights, and priority suburb analysis.
                </p>
                <p style="margin-top: 10px; font-size: 13px; color: #7c3aed; font-weight: 700;">
...
with chat_col:
    ...
    if remaining>0:
        ...
        if last_queried_str:
            ...
            reset_display = "24h"
        st.markdown(f"""
            <div style="background: #e03616; padding: 10px 16px; border-radius: 8px; margin-top: 10px; text-align: center; display: inline-block; width: 100%;">
                <span style="color: #FFFFFF; font-weight: 800; font-size: 16px; letter-spacing: 0.04em;">🔒 ACCESS LOCKED</span>
                <span style="color: #FFFFFF; font-size: 14px; opacity: 0.9; margin-left: 8px;">Resets in <b>{reset_display}</b></span>
            </div>
        """, unsafe_allow_html=True)
